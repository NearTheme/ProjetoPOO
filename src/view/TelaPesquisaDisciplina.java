 ...
 */
public class TelaPesquisaDisciplina extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfCodigocurso = new javax.swing.JFormattedTextField();
        ...
        jScrollPane4.setViewportView(tableDisciplinas);
        ...
        try {
            tfCodigocurso.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("#############")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    ...
                                                    .addComponent(tfSemestre, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(tfCodigocurso, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Object[] dados = {tfCodigo.getText(), tfNome.getText(), tfSemestre.getText(), tfDatainicio.getText(), tfDatafim.getText(), tfCodigocurso.getText()};
    ...
    private void tableDisciplinasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDisciplinasMouseClicked
        ...
        if (tableDisciplinas.getSelectedRow() != -1){
            ...
            tfSemestre.setText(tableDisciplinas.getValueAt(tableDisciplinas.getSelectedRow(), 3).toString());
            tfDatainicio.setText(tableDisciplinas.getValueAt(tableDisciplinas.getSelectedRow(), 4).toString());
            tfDatafim.setText(tableDisciplinas.getValueAt(tableDisciplinas.getSelectedRow(), 5).toString());
            tfCodigocurso.setText(tableDisciplinas.getValueAt(tableDisciplinas.getSelectedRow(), 6).toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaDisciplina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesquisaDisciplina().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JFormattedTextField tfCodigocurso;
